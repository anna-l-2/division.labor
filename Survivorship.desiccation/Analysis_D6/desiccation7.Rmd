...
data <- read.csv("20250522_1635_DA7.csv")# 1 is D6 and 2 is SPO; Event - 0 if lived 1 if died
data
...
plot(biofsurv.fit, conf.int = TRUE, mark.time = FALSE,
  ...
  main = "Survivorship After 4 hr Desiccation",
  yaxt = "n", xaxt = "n")
  box(lwd=2)
...
axis(side = 3, labels = FALSE, lwd.ticks = 2, las = 1, cex.axis = 1.25,
     at = c(0, 24, 48, 72, 96))
text(4.67, .99, "D6; SPOIIE", cex.axis = 1.25)
